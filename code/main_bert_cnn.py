...
from data import fvqa_bert as fvqa
import copy
...
class Runner:
    ...
    def train(self, epoch):
        ...
        for question_features, answers, idx, q_len,input_ids, segment_ids, attention_mask in tq:
            ...
            fusion_embedading = self.fusion_model( question_features, q_len,input_ids, segment_ids, attention_mask)
    ...
    def _model_choice(self, args):
        assert args.fusion_model in ['SAN', 'MLP', 'BAN', 'UD','BERT']
        # models api
